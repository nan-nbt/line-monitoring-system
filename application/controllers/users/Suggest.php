...
class Suggest extends CI_Controller
{
	...
	{
		parent::__construct();
		$this->load->model('Tra_suggest_model');
	...
	public function index()
	{
		...
		$this->load->view('users/basic_data/suggest/list');
	}

	// function get data suggestion using JQuery AJAX
	public function getList()
	{
		$data = $this->Tra_suggest_model->getByFactory($this->schema, $this->dba);
